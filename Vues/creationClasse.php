	...
	<div id="portfolio2">
		...
		<div class="title">
			...
			<div class="content"><form name="creationClasse" method="POST" action="index.php?page=classe">
				...
				<input type="radio" name="record" value="true">Oui<input type="radio" name="record" value="false">Non<br />
				<input type=hidden name=action value="create"><br />
				<input class="button-submit" type="submit" value="Créez votre salle" />
			</form>
			</div>
